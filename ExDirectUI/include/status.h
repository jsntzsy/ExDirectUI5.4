...
namespace ExDirectUI
{
	...
	EX_DECLEAR_STATUS_NAME_STR(EE_NOEXISTS, L"不存在");
	EX_DECLEAR_STATUS_NAME_STR(EE_EXISTS, L"已存在");
	EX_DECLEAR_STATUS_NAME_STR(EE_OUTOFBOUNDS, L"索引超界");
	EX_DECLEAR_STATUS_NAME_STR(EE_UNMATCH, L"不匹配");
	EX_DECLEAR_STATUS_NAME_STR(EE_FORMAT, L"格式错误");
	EX_DECLEAR_STATUS_NAME_STR(EE_IO, L"读写错误");
	EX_DECLEAR_STATUS_NAME_STR(EE_LOAD, L"加载错误");
